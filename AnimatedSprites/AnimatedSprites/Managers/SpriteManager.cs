    ...
    public class SpriteManager : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            player = new UserControlledSprite(
                Game.Content.Load<Texture2D>(@"Images/Characters/CapnSprite"),
                new Vector2 (Game.Window.ClientBounds.Width/2,
                    Game.Window.ClientBounds.Height/2), new Point(92, 74), 10, new Point(0, 0),
            ...
            for (int i = 0; i < ((Main)Game).NumberLivesRemaining; ++i)
            {
                ...
                livesList.Add(new AutomatedSprite(
                    Game.Content.Load<Texture2D>(@"Images/Characters/CaptainWithShield"),
                    new Vector2(offset, 35), new Point(92, 74), 10,
        ...
        private void SpawnEnemy()
        {
            ...
            if (random < likelihoodAutomated)
            {
                ...
                {
                    spriteList.Add(
                        new AutomatedSprite(Game.Content.Load<Texture2D>(@"Images/Characters/EnemySprite"),
                            position, new Point(72, 84), 10, new Point(0, 0), new Point(8, 1),
                            speed, "fourbladescollision", automatedSpritePointValue));
                }
                else 
                {
                    spriteList.Add(
                        new AutomatedSprite(Game.Content.Load<Texture2D>(@"Images/Characters/eTSprite"),
                            position, new Point(72, 84), 10, new Point(0, 0), new Point(8, 1), 
            ...
            else if (random < likelihoodAutomated + likelihoodChasing)
            {
                ...
                spriteList.Add(
                    new ChasingSprite(Game.Content.Load<Texture2D>(@"Images/Characters/EnemyWeapon"),
                        position, new Point(72, 84), 10, new Point(0, 0), new Point(8, 1),
            ...
            else
            {
                ...
                spriteList.Add(
                    new EvadingSprite(Game.Content.Load<Texture2D>(@"Images/Characters/RedSkull"),
                        position, new Point(100, 76), 10, new Point(0, 0), new Point(6, 1),
                        speed, "boltcollision", this, .75f, 150, catchingEvadingSpriteValue));
            }
        }
